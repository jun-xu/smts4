...
//	css_get_env(CSS_LOGGER_MODULE_NAME, "format", DEFAULT_LOG_HEADER_FMT,
//			&css_logger.pattern);
...
//	uv_dirent_t dent;
//	int r;
//	r = uv_fs_scandir(css_logger.loop, &req, css_logger.root_dir, 0, NULL);
//	if (r != 0) {
