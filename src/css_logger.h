...
#define CSS_LOGGER_MAX_FILE_SIZE 15*1024*1024
#define DEFAULT_LOG_BUF_SIZE 3*1024*1024
...
#else
#define CL_LOG(level,...) css_logger_log_inner(__FILE__, __LINE__, __FUNCTION__,getpid(),level, __VA_ARGS__)
